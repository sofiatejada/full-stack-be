...
export default class Favorites {
  ...
  static async insert({ sprite, name, primaryType, secondaryType }) {
    const { rows } = await pool.query('INSERT INTO favorites (sprite, name, primary_type, secondary_type) VALUES ($1, $2, $3, $4) RETURNING *', [sprite, name, primaryType, secondaryType]);
